...
- **변경·migration 순서**: Pages base path와 ZK asset base를 빌드 시 주입 → 검증 → `hackathon/midnight-korea` push → Pages 활성화 → 수동 workflow dispatch
- **승인 참조**: `approvals.yaml` release version 1
